...
jest.mock("@gorhom/bottom-sheet", () => {
  ...
  const BottomSheetTextInput = React.forwardRef(function BottomSheetTextInput(
    props: any,
    ref: any,
  ) {
  ...
  return {
    ...
    BottomSheetView: function BottomSheetView({ children, ...props }: any) {
...
jest.mock("@/components/AurralLogo", () => {
  ...
  const { View } = require("react-native");
  return {
    AurralLogo: function AurralLogo(props: any) {
      return React.createElement(View, { testID: "aurral-logo", ...props });
    },
  };
});
